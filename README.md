...
The `stdout`/`stderr` generated by your command will be propagated onto the top shell (respectively logging as `debug`/`error`) which is buffered on your Homebridge UI.  
